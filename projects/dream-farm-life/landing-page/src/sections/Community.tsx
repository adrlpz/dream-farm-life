...
const socials = [
  { icon: Twitter, name: 'Twitter / X', handle: '@DFarmLife', href: 'https://x.com/DFarmLife', color: 'bg-black text-white' },
  { icon: MessageCircle, name: 'Discord', handle: 'Join Community', href: '#', color: 'bg-indigo-500 text-white' },
  { icon: Send, name: 'Telegram', handle: '@Dreamfarmlife', href: 'https://t.me/Dreamfarmlife', color: 'bg-blue-400 text-white' },
]
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h3 className="font-display font-bold text-xl text-farm-soil mb-3">
            {t('community_newsletter_title')}
          </h3>
          <p className="text-sm text-farm-brown mb-6">
            {t('community_newsletter_desc')}
          </p>
