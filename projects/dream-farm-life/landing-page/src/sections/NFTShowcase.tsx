...
const nfts = [
  { name: 'Golden Wheat Field', type: 'Land', rarity: 'Legendary', rarityColor: 'bg-yellow-400 text-yellow-900', emoji: '🌾', bg: 'from-yellow-100 to-amber-100' },
  { name: 'Crystal Cow', type: 'Animal', rarity: 'Rare', rarityColor: 'bg-purple-400 text-purple-900', emoji: '🐄', bg: 'from-purple-100 to-pink-100' },
  { name: 'Red Barn', type: 'Building', rarity: 'Common', rarityColor: 'bg-gray-300 text-gray-700', emoji: '🏠', bg: 'from-red-100 to-orange-100' },
  { name: 'Rainbow Chicken', type: 'Animal', rarity: 'Rare', rarityColor: 'bg-purple-400 text-purple-900', emoji: '🐔', bg: 'from-pink-100 to-violet-100' },
]
